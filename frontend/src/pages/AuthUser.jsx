            ...
            <div className={`auth-container ${isRightPanelActive ? 'right-panel-active' : ''}`}>
                ...
                <div className="form-container sign-up-container">
                    <form onSubmit={handleRegister}>
                        ...
                        <span>Start your movie journey</span>
                ...
                <div className="form-container sign-in-container">
                    <form onSubmit={handleLogin}>
                        <h1>Sign In</h1>
                        <span>Welcome back, movie lover!</span>
                        ...
                        <Link to="/admin/login" className="auth-link" style={{ marginTop: '20px' }}>
                            Login as Admin
                        </Link>
                    </form>
                </div>
                ...
                <div className="overlay-container">
                    <div className="overlay user-overlay">
                        <div className="overlay-panel overlay-left">
                            <h1>Welcome Back!</h1>
                            <p>Already have an account? Sign in to continue exploring movies!</p>
                            <button
                        ...
                        <div className="overlay-panel overlay-right">
                            ...
                            <p>Don't have an account yet? Create one and start building your watchlist!</p>
                            <button
                                className="auth-btn ghost"
